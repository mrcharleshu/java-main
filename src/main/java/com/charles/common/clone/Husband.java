...
public class Husband implements Cloneable {
    ...
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        System.out.println("husband object equals = " + (husband.equals(husband2)));//true
        ...
        System.out.println("wife object equals = " + (husband.getWife().equals(husband2.getWife())));//true
    }
}  